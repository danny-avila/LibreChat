...
LibreChat 将助理 AI 的未来与 OpenAI ChatGPT 的革命性技术相结合。在保留原始风格的基础上，LibreChat 赋予您集成多种 AI 模型的能力。它还集成并增强了原始客户端功能，如对话与消息搜索、提示词模板和插件系统。

有了 LibreChat，您不再需要购买 ChatGPT Plus，而是可以使用免费或按量计费的 API。我们欢迎任何形式的贡献、克隆和分叉，以增强这一先进聊天机器人平台的能力。
