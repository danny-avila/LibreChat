                ...
                >
                  <nav className="flex h-full w-full flex-col px-3 pb-3.5 pb-0">
                    <div className="flex flex h-14 items-center justify-between">
                      ...
                      <button className="text-[#7D7D7D] dark:text-[#b4b4b4] hover:bg-gray-100 dark:hover:bg-gray-800 focus-visible:bg-token-sidebar-surface-secondary h-10 rounded-lg px-2.5 focus-visible:outline-0">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
