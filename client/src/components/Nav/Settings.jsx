      ...
      <DialogContent className={cn('shadow-2xl dark:bg-gray-900 dark:text-white')}>
        ...
        <div className="px-6">
          ...
          >
            ...
            >
              <Tabs.Trigger
                className="radix-state-active:bg-gray-800 radix-state-active:text-white flex items-center justify-start gap-2 rounded-md px-2 py-1.5 text-sm"
                value="general"
              >
                <GearIcon />
                General
              ...
              <div className="flex flex-col gap-3 text-sm text-gray-600 dark:text-gray-300">
                <div className="border-b pb-3 last-of-type:border-b-0 dark:border-gray-700">
                  <div className="flex items-center justify-between">
                    <div>Theme</div>
                    <select className="rounded border border-black/10 bg-transparent text-sm dark:border-white/20 w-24">
