...
export default function MobileNav({ setNavVisible }) {
  ...
  return (
    <div className="fixed left-0 right-0 top-0 z-10 flex items-center bg-white/95 px-1 border-b border-token-border-medium dark:bg-gray-800/90 dark:text-white sm:pl-3 md:hidden">
      <button
        type="button"
