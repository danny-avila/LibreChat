...
import { ManagementTabValues } from 'librechat-data-provider';
...
export default function Management({ open, onOpenChange }: TDialogProps) {
          ...
          >
            ...
            >
              ...
              <div className="max-h-[373px] overflow-auto px-6 md:min-h-[373px] md:w-[680px]">
                <Tabs.Root
                  defaultValue={ManagementTabValues.ACCOUNT}
                ...
                >
                  ...
                  >
                    <Tabs.Trigger
                      ...
                      value={ManagementTabValues.ACCOUNT}
                      style={{ userSelect: 'none' }}
                    >
                      <GearIcon />
                      {localize('com_nav_management_account')}
                    </Tabs.Trigger>
                    <Tabs.Trigger
                      tabIndex={0}
                      className={cn(
                      ...
                      value={ManagementTabValues.BALANCE}
                      style={{ userSelect: 'none' }}
                    >
                      <GearIcon />
                      {localize('com_nav_management_balance')}
                    </Tabs.Trigger>
                    <Tabs.Trigger
                      tabIndex={0}
                      className={cn(
                      ...
                      value={ManagementTabValues.STATISTICS}
                      style={{ userSelect: 'none' }}
                    >
                      <GearIcon />
                      {localize('com_nav_management_statistics')}
                    </Tabs.Trigger>
                    <Tabs.Trigger
                      tabIndex={0}
                      className={cn(
                      ...
                      value={ManagementTabValues.SENSITIVE_WORDS}
                      style={{ userSelect: 'none' }}
                    >
                      <GearIcon />
                      {localize('com_nav_management_sensitive_words')}
                    </Tabs.Trigger>
                  </Tabs.List>
