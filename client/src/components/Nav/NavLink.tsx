...
const NavLink: FC<Props> = forwardRef<HTMLAnchorElement, Props>((props, ref) => {
  ...
  const defaultProps: {
    ...
    className: cn(
      'flex gap-2 rounded p-2.5 text-sm cursor-pointer focus:ring-0 group items-center transition-colors duration-200 hover:bg-gray-500/10 dark:text-white dark:hover:bg-gray-700',
      className,
      {
