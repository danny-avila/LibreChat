...
export const blockchainNetworks: BlockchainNetwork[] = [
  {
    ...
    scanUrl: 'https://www.blockchain.com/',
  },
  {
    id: CryptoId.ETH,
    label: 'Ethereum',
  ...
  },
  {
    ...
    scanUrl: 'https://cardanoexplorer.com/',
  },
  {
    id: CryptoId.XRP,
    label: 'XRP',
  ...
  },
  {
    ...
    scanUrl: 'https://explore.veforge.com/',
  },
  {
    id: CryptoId.TRX,
    label: 'Tron',
  ...
  //   scanUrl: 'https://moneroblocks.info/',
  // },
  {
    id: CryptoId.AAVE,
    label: 'Aave',
  ...
  },
  {
    ...
    scanUrl: 'https://explorer.dash.org/',
  },
  {
    id: CryptoId.NEM,
    label: 'NEM',
    ...
    scanUrl: 'https://zcashnetwork.info/',
  },
  {
    id: CryptoId.ZEC,
    label: 'Zcash',
    ...
    scanUrl: 'http://explorer.nemtool.com',
  },
  {
    id: CryptoId.SLORP,
    label: 'Slorp',
