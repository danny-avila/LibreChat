    ...
    <>
      <div className="flex items-center justify-between">
        ...
        <label
          ...
          className="flex h-auto cursor-pointer items-center rounded bg-transparent px-2 py-1 text-xs font-medium font-normal transition-colors hover:bg-gray-100 hover:text-green-700 dark:bg-transparent dark:text-white dark:hover:bg-gray-700 dark:hover:text-green-500"
        >
      ...
      <Dialog open={isDialogOpen} onOpenChange={() => setDialogOpen(false)}>
        <DialogContent
          className={cn('shadow-2xl dark:bg-gray-750 dark:text-white md:h-[350px] md:w-[450px] ')}
