...
const SearchBar = forwardRef((props: SearchBarProps, ref: Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className="relative mt-1 flex flex h-10 cursor-pointer items-center gap-3 rounded-lg border-white bg-gray-50 px-2 px-3 py-2 text-black transition-colors duration-200 focus-within:bg-gray-200 hover:bg-gray-200 dark:bg-black dark:text-white dark:focus-within:bg-black dark:hover:bg-black"
    >
