...
const SearchBar = forwardRef((props: SearchBarProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className="group relative flex h-9 min-w-0 flex-1 cursor-pointer items-center gap-3 rounded-lg border-2 border-transparent px-3 py-1.5 text-text-primary focus-within:bg-surface-active-alt hover:bg-surface-active-alt"
    >
      <Search
        aria-hidden="true"
