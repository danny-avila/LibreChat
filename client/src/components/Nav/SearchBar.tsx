...
const SearchBar = forwardRef((props: SearchBarProps, ref: Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className="relative mt-1 flex flex h-10 cursor-pointer items-center gap-3 rounded-lg border-white bg-gray-50 px-2 px-3 py-2 text-black transition-colors duration-200 hover:bg-gray-100 focus:bg-gray-900 dark:bg-gray-950 dark:text-white dark:hover:bg-gray-900"
    >
