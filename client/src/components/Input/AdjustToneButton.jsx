...
export default function AdjustToneButton({ onClick }) {
  ...
  return (
    <button
      ...
      className="group absolute bottom-11 right-0 z-[62] flex h-[100%] w-[50px] items-center justify-center bg-transparent p-1 text-gray-500 lg:-right-11 lg:bottom-0"
    >
