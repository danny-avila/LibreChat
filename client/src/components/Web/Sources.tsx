  ...
  return (
    <div role="region" aria-label={localize('com_sources_region_label')}>
      <AnimatedTabs
        ...
        tabClassName="flex items-center whitespace-nowrap text-xs font-medium text-text-secondary px-1 pt-2 pb-1 border-b-2 border-transparent data-[state=active]:text-text-primary outline-hidden focus:ring-2 focus:ring-text-primary focus:ring-offset-2"
      />
    </div>
  );
}
