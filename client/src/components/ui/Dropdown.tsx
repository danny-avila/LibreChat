          ...
          >
            {options.map((item, index) => (
              <Listbox.Option
                ...
                className={cn(
                  'duration-50 relative cursor-pointer select-none rounded border-gray-50 bg-white py-2.5 pl-3 pr-6 text-black transition-all ease-in-out hover:bg-gray-100 focus:bg-gray-200 dark:border-gray-50 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus:bg-gray-500',
                )}
                style={{ width: '100%' }}
