...
import { Permissions, SystemRoles, roleDefaults, PermissionTypes } from 'brainiac-data-provider';
import {
  OGDialog,
  OGDialogTitle,
  OGDialogContent,
                      ...
                      {showAdminWarning &&
                        ...
                        permission === Permissions.USE && (
                          <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                            ...
                            {'\n'}
                            <a
                              href="https://www.brainiac.ai/docs/configuration/brainiac_yaml/object_structure/interface"
                              target="_blank"
                              rel="noreferrer"
