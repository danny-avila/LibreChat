...
const buttonVariants = cva(
  'rounded-full inline-flex items-center justify-center text-sm font-medium transition-colors focus:outline-none dark:hover:bg-gray-700 dark:hover:text-gray-100 disabled:opacity-50 disabled:pointer-events-none data-[state=open]:bg-gray-100 dark:data-[state=open]:bg-gray-700',
  {
    variants: {
      variant: {
        default: 'bg-gray-800 text-white hover:bg-gray-800 dark:bg-gray-50 dark:text-gray-900',
