...
function Login() {
  ...
  return (
    ...
    <div className="mb-6">
      ...
      <input className="shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Enter your password" />
      ...
      <p>insert vera auth token</p>
        ...
        <button className="ml-2 border" onClick={(e) => {console.log(pk); loginVera(pk)}}> Submit</button>
    </div>
  );
}
