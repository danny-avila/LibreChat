    ...
    >
      <div className="mb-2">
        <div className="relative">
          <input
            ...
            className="peer block w-full appearance-none rounded-md border border-gray-300 bg-white px-2.5 pb-2.5 pt-5 text-sm text-gray-900 focus:border-green-500 focus:outline-none focus:ring-0 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 dark:focus:border-green-500"
            placeholder=" "
          />
          <label
            htmlFor="email"
      ...
      <div className="mt-6">
        <button
          ...
          type="submit"
          className="w-full transform rounded-md bg-green-500 px-4 py-3 tracking-wide text-white transition-all duration-300 hover:bg-green-550 focus:bg-green-550 focus:outline-none dark:text-gray-100"
        >
