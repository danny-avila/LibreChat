...
function ResetPassword() {
  ...
  if (resetPassword.isSuccess) {
    return (
      <>
        <div
          className="relative mt-6 rounded-xl border border-brand-blue-500/20 bg-brand-blue-50/50 px-6 py-4 text-brand-blue-700 shadow-sm transition-all dark:bg-brand-blue-950/30 dark:text-brand-blue-100"
          role="alert"
        >
