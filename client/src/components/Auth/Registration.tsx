  ...
  return (
    <>
      ...
      {registerUser.isSuccess && countdown > 0 && (
        <div
          className="rounded-md border border-gray-400 bg-gray-500/10 px-3 py-2 text-sm text-gray-600 dark:text-gray-200"
          role="alert"
        >
          {localize(
        ...
        <>
          ...
          <p className="my-4 text-center text-sm font-light text-gray-700 dark:text-white">
            ...
            <a
              href={loginPage()}
              aria-label="Login"
              className="inline-flex p-1 text-sm font-medium text-gray-800 transition-colors hover:text-black dark:text-gray-200 dark:hover:text-white"
            >
