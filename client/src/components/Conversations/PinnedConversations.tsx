...
const SortableConvo = memo(({ conversation, toggleNav, index, moveConvo, onDragEnd }: SortableConvoProps) => {
  ...
  return (
    <div
      ref={ref}
      className={`group relative cursor-grab active:cursor-grabbing ${isDragging ? 'opacity-30 rounded-md border border-border-light bg-surface-primary shadow-lg' : ''}`}
