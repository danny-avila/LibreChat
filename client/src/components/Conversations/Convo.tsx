...
export default function Conversation({ conversation, retainView, toggleNav, isLatestConvo }) {
  ...
  const aProps = {
    className: `group relative rounded-lg active:opacity-50 flex cursor-pointer items-center mt-2 gap-2 break-all rounded-lg bg-gray-800 py-2 px-2 `,
  };
  ...
  return (
    ...
    >
      ...
      {activeConvo ? (
        ...
        <div className="absolute bottom-0 right-0 top-0 w-2 bg-gradient-to-l from-gray-900 from-0% to-transparent group-hover:w-1 group-hover:from-60%"></div>
      )}
      {activeConvo ? (
