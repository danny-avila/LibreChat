...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@vestai/client';
import { PermissionTypes, Permissions, QueryKeys } from 'vestai-data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | VestAI`);
