    ...
    <>
      <div className="sticky top-0 w-full z-10">
        <div className='flex flex-row w-full gap-2 justify-center items-center border-b px-1 border-black/10 bg-gray-50 dark:border-gray-900/50 dark:bg-gray-700 dark:text-gray-200'>
          ...
          <button onClick={ copyShareLinkHandler } className='flex flex-row gap-1 items-center justify-center text-lg px-1 hover:bg-gray-200 hover:dark:bg-gray-500'>
          ...
          <button
            className='flex flex-row items-center gap-1 ml-0.5 pr-1 text-lg hover:bg-gray-200 hover:dark:bg-gray-500'
            onClick={ likeHandler }
          >
            <div className='p-1'>
