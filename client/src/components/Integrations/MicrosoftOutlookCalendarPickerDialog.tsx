...
import { useMicrosoftOutlookCalendarEventsQuery } from '~/data-provider';
...
interface MicrosoftOutlookCalendarPickerDialogProps {
  isOpen: boolean;
...
export function MicrosoftOutlookCalendarPickerDialog({
  isOpen,
  onOpenChange,
  onEventsSelected,
  isAttaching = false,
  maxSelectionCount,
  onReconnect,
}: MicrosoftOutlookCalendarPickerDialogProps) {
  ...
  const { data, isLoading, isFetching, isError, error } = useMicrosoftOutlookCalendarEventsQuery({
  ...
  return (
    <IntegrationPickerDialogShell
      ...
      titleKey="com_integrations_outlook_calendar_picker_title"
      searchPlaceholderKey="com_integrations_outlook_calendar_picker_search"
      searchValue={search}
