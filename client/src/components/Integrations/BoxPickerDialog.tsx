...
import { useBoxFilesQuery } from '~/data-provider';
...
export function BoxPickerDialog({
  isOpen,
  onOpenChange,
  onFilesSelected,
  isAttaching = false,
  ...
  const { data, isLoading, isFetching, isError, error } = useBoxFilesQuery({
  ...
  return (
    <IntegrationPickerDialogShell
      ...
      titleKey="com_integrations_box_picker_title"
      searchPlaceholderKey="com_integrations_box_picker_search"
      searchValue={search}
