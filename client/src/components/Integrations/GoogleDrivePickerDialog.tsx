...
import { useGoogleDriveFilesQuery } from '~/data-provider';
...
export function GoogleDrivePickerDialog({
  ...
  return (
    <IntegrationPickerDialogShell
      ...
      titleKey="com_integrations_drive_picker_title"
      searchPlaceholderKey="com_integrations_drive_picker_search"
      searchValue={search}
