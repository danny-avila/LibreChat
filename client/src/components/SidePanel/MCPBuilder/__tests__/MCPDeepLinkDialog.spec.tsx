...
it('does not mount the server form for ordinary chats without a deep link', () => {
  mockUseHasAccess.mockReturnValue(true);
  render(<MCPDeepLinkDialog isOpen={false} initialValues={undefined} onOpenChange={jest.fn()} />);
  expect(screen.queryByTestId('mcp-server-dialog')).not.toBeInTheDocument();
});
