...
export default function ActionsAuth({
  ...
  return (
    <DialogContent
      ...
      data-state="open"
      className="left-1/2 col-auto col-start-2 row-auto row-start-2 w-full max-w-md -translate-x-1/2 rounded-xl bg-white pb-0 text-left shadow-xl transition-all dark:bg-gray-750 dark:text-gray-100"
      tabIndex={-1}
            ...
            <div className="flex items-center gap-2 text-gray-500">
              <label htmlFor=":rfc:" className="flex cursor-not-allowed items-center gap-1">
                <RadioGroup.Item
                  ...
                  id=":rfc:"
                  className="mr-1 flex h-5 w-5 cursor-not-allowed items-center justify-center rounded-full border border-gray-500 bg-gray-300 dark:border-gray-700 dark:bg-gray-750"
                  tabIndex={-1}
                >
                  <RadioGroup.Indicator className="h-2 w-2 rounded-full bg-gray-950 dark:bg-white"></RadioGroup.Indicator>
                </RadioGroup.Item>
  ...
  return (
    <>
      ...
      <input
        ...
        type="password"
        autoComplete="off"
        className="border-token-border-medium mb-2 h-9 w-full resize-none overflow-y-auto rounded-lg border px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-400 dark:bg-gray-750"
        ...
        <div className="flex items-center gap-2">
          <label htmlFor=":rj1:" className="flex cursor-pointer items-center gap-1">
            <RadioGroup.Item
              ...
              id=":rj1:"
              className="mr-1 flex h-5 w-5 items-center justify-center rounded-full border border-gray-500 bg-white dark:border-gray-700 dark:bg-gray-750"
              tabIndex={-1}
            >
              <RadioGroup.Indicator className="h-2 w-2 rounded-full bg-gray-950 dark:bg-white"></RadioGroup.Indicator>
            </RadioGroup.Item>
