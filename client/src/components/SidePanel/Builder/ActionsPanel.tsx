import type { AssistantPanelProps } from '~/common';
      ...
      <div className="h-full overflow-auto px-2 pb-12 text-sm">
        ...
        <div className="relative mb-6">
          <div className="mb-1.5 flex items-center">
            <label className="text-token-text-primary block font-medium">Authentication</label>
          </div>
          <div className="border-token-border-medium flex rounded-lg border text-sm hover:cursor-pointer">
            <div className="h-9 grow px-3 py-2">None</div>
        ...
        <ActionsInput action={action} assistant_id={assistant_id} />
      </div>
    </div>
  );
}
