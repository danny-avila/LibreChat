      ...
      <TooltipProvider delayDuration={0}>
        ...
        >
          ...
          <ResizablePanel
            ...
            className={cn(
              'sidenav hide-scrollbar border-l border-border-light bg-surface-primary transition-opacity',
          ...
          >
            {interfaceConfig.modelSelect && (
              <div
                className={cn(
                  'sticky left-0 right-0 top-0 z-[100] flex h-[52px] flex-wrap items-center justify-center bg-surface-primary',
