...
import { useUserKeyQuery } from 'bizu-data-provider/react-query';
import { ResizableHandleAlt, ResizablePanel, useMediaQuery } from '@bizu/client';
import type { TEndpointsConfig, TInterfaceConfig } from 'bizu-data-provider';
