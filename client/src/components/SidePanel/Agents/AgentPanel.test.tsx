...
jest.mock('brainiac-data-provider', () => {
  const actualModule = jest.requireActual('brainiac-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('brainiac-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'brainiac-data-provider';
