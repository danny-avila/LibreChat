...
import type { AgentForm, Option, AgentModelPanelProps } from '~/common';
import { SelectDropDown, ModelParameters } from '~/components/ui';
import { Panel, NotificationSeverity } from '~/common';
...
export default function ModelPanel({
  ...
  const { control, setValue, handleSubmit, watch } = useFormContext<AgentForm>();
  ...
  const onSubmit = (data: AgentForm) => {
    ...
    showToast({
      message: localize('com_ui_model_save_success'),
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="h-full grow overflow-hidden">
