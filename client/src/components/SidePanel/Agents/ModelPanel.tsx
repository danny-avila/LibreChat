...
import { getSettingsKeys, alternateName, agentParamSettings } from 'librechat-data-provider';
...
export default function ModelPanel({
  ...
  const parameters = useMemo(() => {
    ...
    return defaultParams.map(param => overriddenParamsMap[param.key] ?? param);
