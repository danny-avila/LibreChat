    ...
    <>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          onClick={saveAction}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-brand-blue-500 px-4 py-2 font-semibold text-white hover:bg-brand-blue-400 focus:border-brand-blue-500 focus:outline-none focus:ring-0 disabled:bg-brand-blue-400"
          type="button"
        >
          {getButtonContent()}
        </button>
