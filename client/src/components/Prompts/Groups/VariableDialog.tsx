...
const VariableDialog: React.FC<VariableDialogProps> = ({ open, onClose, group }) => {
  ...
  return (
    <OGDialog open={open} onOpenChange={handleOpenChange}>
      <OGDialogContent className="grid-cols-[minmax(0,1fr)] max-h-[90vh] max-w-full overflow-x-hidden overflow-y-auto bg-white dark:border-gray-700 dark:bg-gray-850 dark:text-gray-300 md:max-w-[60vw]">
