...
const MenuItem: FC<MenuItemProps> = ({
  ...
  return (
    <div
      role="menuitem"
      className="group m-1.5 flex min-w-[240px] cursor-pointer gap-2 rounded px-5 py-2.5 !pr-3 text-sm !opacity-100 hover:bg-black/5 focus:ring-0 radix-disabled:pointer-events-none radix-disabled:opacity-50 dark:hover:bg-white/5"
      tabIndex={-1}
      onClick={onClick}
    >
