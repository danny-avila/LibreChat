...
const MenuItem: React.FC<MenuItemProps> = ({ title, value: endpoint, description, selected }) => {
  // [EModelEndpoint.google]: img src="/assets/google-palm.svg" alt="Palm Icon" />,
  // [EModelEndpoint.bingAI]: img src="/assets/bingai-jb.png" alt="Bing Icon" />
  ...
  return (
    ...
    >
      <div className="flex grow items-start justify-between gap-2">
        ...
        <div className="text-token-text-primary hidden group-hover:flex">
          <div className="absolute right-11">New Chat</div>
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
