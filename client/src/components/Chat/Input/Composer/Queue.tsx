 ...
 * the run accepts it and sends as the next turn otherwise, so the button
 * never has to name a mechanism.
 */
      ...
      {queued.map((message: QueuedMessage) => (
        ...
        >
          ...
          <button
            ...
            className="shrink-0 rounded-lg px-2 py-0.5 text-sm font-medium text-text-primary transition-colors hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-border-xheavy"
          >
