...
export default function StreamAudioCall({ index = 0 }) {
  ...
  const setStreamAudioActive = useSetRecoilState(store.streamAudioActiveState);
  ...
  useEffect(() => {
    ...
    console.log('Fetching audio...', shouldFetch);
    ...
    async function fetchAudio() {
      ...
      try {
        ...
        if (cachedResponse) {
          ...
          setIsFetching(false);
          setStreamAudioActive(true); // Set streamAudioActive to true
          return;
        }
