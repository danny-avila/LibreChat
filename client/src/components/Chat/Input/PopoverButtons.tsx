        ...
        {endpointButtons.map((button, index) => (
          <Button
            ...
            className={cn(
              ...
              'ml-1 h-full bg-transparent px-2 py-1 text-xs font-medium font-normal text-black hover:bg-gray-100 hover:text-black dark:bg-transparent dark:text-white dark:hover:bg-gray-700 dark:hover:text-white',
              buttonClass ?? '',
            )}
          ...
          {additionalButtons[settingsView].map((button, index) => (
            <Button
              ...
              className={cn(
                ...
                'h-full w-full bg-transparent px-2 py-1 text-xs font-medium font-normal text-black hover:bg-gray-100 hover:text-black dark:bg-transparent dark:text-white dark:hover:bg-gray-700 dark:hover:text-white',
                buttonClass ?? '',
              )}
              onClick={button.handler}
            >
