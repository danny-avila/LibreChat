    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className="z-10 mr-4 h-8 w-8 border-none p-0 transition-all duration-300 ease-in-out focus-visible:ring focus-visible:ring-opacity-75 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-900"
        >
