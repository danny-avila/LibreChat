          ...
          return (
            ...
            >
              ...
              <TextareaAutosize
                ...
                disabled={isBusy}
                minRows={3}
                className="max-h-[65vh] min-h-24 w-full resize-y rounded-lg border border-border-medium bg-surface-primary px-3 py-2 text-sm font-normal text-text-primary focus-visible:border-border-heavy focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-text-primary disabled:opacity-50 md:max-h-[75vh]"
              />
            </label>
          );
        })}
