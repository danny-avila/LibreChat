...
export default function Landing({ centerFormOnLanding }: { centerFormOnLanding: boolean }) {
  ...
  const greetingText = 'Ask a Canadian building code question';

  return (
    <div
      className={`flex h-full transform-gpu flex-col items-center justify-center pb-16 pt-2 transition-all duration-200 ${centerFormOnLanding ? 'max-h-full' : 'max-h-full'} ${getDynamicMargin}`}
    >
