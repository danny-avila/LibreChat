...
import { CanvasProseMirror } from "~/components/Canvas";
...
export default function Presentation({
  ...
  const canvasData = useRecoilValue(store.canvasState);
  const canvasVisibility = useRecoilValue(store.canvasVisibility);
    ...
    <DragDropWrapper className="relative flex w-full grow overflow-hidden bg-presentation">
      <SidePanelProvider>
        <SidePanelGroup
          ...
          artifacts={
            canvasVisibility === true && canvasData ? (
              <CanvasProseMirror />
