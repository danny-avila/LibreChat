...
export default function  Landing() {
  ...
  return (
    <>
      ...
      <section>
        <h2>HOA Rules Don’t Have to Be Complicated</h2>
      ...
      <section>
        <h2>Trusted by Condo Owners and Boards</h2>
      ...
      <section className="cta-final">
        <h2>Smarter Communities Start with Clarity</h2>
        ...
        <div className="cta-buttons">
          <button className="btn-primary">Get Started with DeclaRAY</button>
        </div>
      </section>
