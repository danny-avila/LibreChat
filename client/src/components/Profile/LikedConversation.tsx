  ...
  function ListItem({ convo }: { convo: TConversation }) {
    ...
    return(
      <div className="group relative flex flex-row items-center cursor-pointer my-2" >
        <div
          className='flex flex-row h-full w-full items-center rounded-lg px-2 py-2 gap-2 text-lg hover:bg-gray-200 dark:hover:bg-gray-600'
          onClick={() => {
        ...
        <button
          className='visible bg-white absolute rounded-md right-1 z-10 p-1 hover:bg-gray-200 dark:hover:bg-gray-600'
          onClick={() => {
