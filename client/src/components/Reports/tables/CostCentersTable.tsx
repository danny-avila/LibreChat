...
function CostCentersTable({ data, isLoading }: CostCentersTableProps) {
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="font-bold text-left text-green-400">{formatReportCost(cost)}</div>
          );
        },
      },
    ],
...
export default memo(CostCentersTable);
