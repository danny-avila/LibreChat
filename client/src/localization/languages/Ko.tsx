...
export default {
  ...
  com_ui_enter: 'Enter',
  com_ui_submit: '제출',
  com_ui_upload_success: '파일 업로드에 성공했습니다',
  ...
  com_ui_clear: '지우기',
  com_ui_revoke: '취소',
  com_ui_revoke_info: '사용자가 제공한 모든 자격 증명을 취소합니다.',
  com_ui_confirm_action: '작업 확인',
  com_ui_chats: '대화',
  com_ui_delete: '삭제',
  com_ui_delete_conversation: '대화를 삭제하시겠습니까?',
  com_ui_delete_conversation_confirm: '이 작업은 삭제합니다',
  ...
  com_auth_reset_password_link_sent: '이메일이 전송되었습니다',
  com_auth_reset_password_email_sent:
    '비밀번호 재설정에 대한 자세한 지침이 포함된 이메일이 전송되었습니다.',
  ...
  com_auth_submit_registration: '등록 제출',
  ...
  com_endpoint_bing_context_placeholder:
    'Bing은 대화에서 참조할 수 있는 "컨텍스트"에 최대 7,000개의 토큰을 사용할 수 있습니다. 구체적인 제한은 알려져 있지 않지만, 7,000개의 토큰을 초과하면 오류가 발생할 수 있습니다.',
  com_endpoint_bing_system_message_placeholder:
    '경고: 이 기능의 오용으로 인해 Bing 사용이 금지될 수 있습니다! "시스템 메시지"를 클릭하여 전체 지침과 기본 메시지(생략된 경우 "시드니" 프리셋)를 확인하세요. 이 프리셋은 안전하다고 간주됩니다.',
  ...
  com_endpoint_google_topp:
    'Top P는 모델이 출력 토큰을 선택하는 방식을 변경합니다. Top K와 함께 사용되며, 모델의 어휘 사전에서 가장 확률이 높은 토큰부터 가장 낮은 토큰까지 선택됩니다.',
  com_endpoint_google_topk:
    'Top K는 모델이 출력 토큰을 선택하는 방식을 변경합니다. Top K가 1이면 모델의 어휘 사전에서 가장 확률이 높은 토큰이 선택됩니다(탐욕적 디코딩). Top K가 3이면 다음 토큰은 가장 확률이 높은 3개의 토큰 중에서 선택됩니다(온도 사용).',
  com_endpoint_google_maxoutputtokens:
    '응답에서 생성할 수 있는 최대 토큰 수입니다. 짧은 응답에는 낮은 값을, 긴 응답에는 높은 값을 지정하세요.',
  com_endpoint_google_custom_name_placeholder: 'PaLM2에 대한 사용자 정의 이름을 설정하세요.',
  com_endpoint_prompt_prefix_placeholder:
    '사용자 정의 지시사항이나 컨텍스트를 설정하세요. 비어 있으면 무시됩니다.',
  ...
  com_endpoint_openai_topp:
    '온도와 함께 사용되는 샘플링 대안으로, 모델이 상위 p 확률 질량을 가진 토큰의 결과를 고려합니다. 0.1은 확률 질량의 상위 10%를 구성하는 토큰만 고려합니다. 이 값을 변경하거나 온도를 변경하는 것을 권장합니다.',
  ...
  com_endpoint_anthropic_maxoutputtokens:
    '응답에서 생성할 수 있는 최대 토큰 수입니다. 짧은 응답에는 낮은 값을, 긴 응답에는 높은 값을 지정하세요.',
  com_endpoint_anthropic_custom_name_placeholder: 'Anthropic에 대한 사용자 정의 이름을 설정하세요.',
  ...
  com_endpoint_set_custom_name: '이 프리셋을 찾을 수 있도록 사용자 정의 이름을 설정하세요.',
  ...
  com_endpoint_show: '보기',
  com_endpoint_examples: '프리셋',
  com_endpoint_completion: '완료',
  com_endpoint_agent: '에이전트',
  com_endpoint_show_what_settings: '{0} 설정 보기',
  com_endpoint_save: '저장',
  com_endpoint_export: '내보내기',
  com_endpoint_save_as_preset: '프리셋으로 저장',
  com_endpoint_presets_clear_warning: '모든 프리셋을 지우시겠습니까? 이 작업은 되돌릴 수 없습니다.',
  com_endpoint_not_implemented: '구현되지 않음',
  com_endpoint_no_presets: '아직 프리셋이 없습니다.',
  com_endpoint_not_available: '사용할 수 있는 엔드포인트가 없습니다.',
  ...
  com_endpoint_config_key_for: '다음을 위한 API 키 설정',
  com_endpoint_config_key_name: '키',
  com_endpoint_config_value: '다음을 위한 값을 입력하세요',
  com_endpoint_config_key_name_placeholder: '먼저 API 키를 설정하세요',
  com_endpoint_config_key_encryption: '키는 암호화되어 만료 시간에 삭제됩니다',
  ...
  com_endpoint_config_key_import_json_key_invalid:
    '잘못된 서비스 계정 JSON 키입니다. 올바른 파일을 가져왔는지 확인하세요.',
  com_endpoint_config_key_get_edge_key: 'Bing에 대한 액세스 토큰을 얻으려면 다음에 로그인하세요',
  com_endpoint_config_key_get_edge_key_dev_tool:
    '사이트에 로그인한 상태에서 개발 도구나 확장 프로그램을 사용하여 _U 쿠키의 내용을 복사하세요. 실패하는 경우 다음',
