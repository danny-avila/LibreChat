...
export default {
  ...
  com_nav_reverse_proxy_url_request: 'Ingresa la URL de tu Proxy Inverso',
  com_nav_reverse_proxy_api: 'Clave de API',
  com_nav_reverse_proxy_api_request: 'Ingresa tu API de Proxy Inverso',
};
