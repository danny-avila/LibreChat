...
export default {
  ...
  com_ui_monthly_plan: 'Plan Mensual',
  com_ui_quarterly_plan: 'Plan Trimestral',
  com_ui_yearly_plan: 'Plan Anual',
  com_ui_monthly_benefits: 'Cuota de Chat Ilimitada',
  com_ui_quartely_benefits: '10% Ahorros Mensuales',
  com_ui_yearly_benefits: '20% Ahorros Mensuales',
  ...
  com_ui_access_info: 'Disfruta de tu acceso a AITok, disponible desde {subscriptionStartDate} hasta {expirationDate}.',
  com_ui_renewal_reminder: 'Para un disfrute ininterrumpido, por favor renueva tu suscripción antes de {expirationDate}.',
