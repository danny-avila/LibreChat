...
export default {
  ...
  com_ui_monthly_plan: 'Piano Mensile',
  com_ui_quarterly_plan: 'Piano Trimestrale',
  com_ui_yearly_plan: 'Piano Annuale',
  com_ui_monthly_benefits: 'Quota di Chat Illimitata',
  com_ui_quartely_benefits: 'Risparmio Mensile del 10%',
  com_ui_yearly_benefits: 'Risparmio Mensile del 20%',
  com_ui_wechat: 'WeChat Pay',
  com_ui_ali: 'Alipay',
  com_ui_union: 'UnionPay',
  com_ui_confirmation_for_subscribing: '🎉 Successo! Il tuo pagamento è confermato!',
  com_ui_thanks_for_subscribing: 'Grazie di cuore per labbonamento! Abbiamo elaborato con successo il tuo pagamento.',
  com_ui_access_info: 'Goditi laccesso ad AITok, disponibile dal {subscriptionStartDate} fino al {expirationDate}.',
  com_ui_renewal_reminder: 'Per un godimento ininterrotto, si prega di rinnovare labbonamento entro il {expirationDate}.',
  com_ui_payment_failed_title: 'Pagamento Fallito',
  com_ui_encountered_issue: 'Abbiamo riscontrato un problema nell elaborazione del tuo pagamento: {errore}',
  com_ui_try_again_or_contact_support: 'Per favore riprova o contatta l assistenza per aiuto.',
