...
export default {
  ...
  com_ui_access_info: 'Goditi laccesso ad AITok, disponibile dal {startTime} fino al {endTime}.',
  com_ui_renewal_reminder: 'Per un godimento ininterrotto, si prega di rinnovare labbonamento entro il {endTime}.',
