...
export default {
  ...
  com_ui_monthly_plan: 'Monatsplan',
  com_ui_quarterly_plan: 'Vierteljährlicher Plan',
  com_ui_yearly_plan: 'Jahresplan',
  com_ui_monthly_benefits: 'Unbegrenztes Chat-Kontingent',
  com_ui_quartely_benefits: '10% Monatliche Einsparungen',
  com_ui_yearly_benefits: '20% Monatliche Einsparungen',
