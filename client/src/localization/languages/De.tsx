...
export default {
  ...
  com_ui_access_info: 'Genießen Sie Ihren Zugang zu AITok, verfügbar von {startTime} bis {endTime}.',
  com_ui_renewal_reminder: 'Für ununterbrochenen Genuss, erneuern Sie bitte Ihr Abonnement bis {endTime}.',
