...
export default {
  ...
  com_auth_no_account: 'Еще не зарегестрированы?',
  ...
  com_auth_already_have_account: 'Уже зарегестрированы?',
  ...
  com_endpoint_func_hover: 'Вкючить использование плагинов как функции OpenAI',
  ...
  com_endpoint_config_key_chatgpt: 'Чтобы получить токен доступа к "Бесплатной Версиии" ChatGPT, войдите в',
