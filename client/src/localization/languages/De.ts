...
export default {
  ...
  com_ui_operations: 'Operations',
  com_ui_marketing: 'Marketing',
  com_ui_techops: 'TechOps',
  com_ui_commercial: 'Commercial',
  com_ui_product: 'Product',
  com_ui_people_ops: 'People Ops',
