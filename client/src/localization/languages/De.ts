...
export default {
  ...
  com_ui_currently_production: 'Aktuell in Produktion',
  com_ui_latest_version: 'Neueste Version',
  com_ui_filter_prompts: 'Prompts filtern',
  com_ui_latest_production_version: 'Neueste Produktionsversion',
  com_ui_confirm_change: 'Änderung bestätigen',
  com_ui_confirm_admin_use_change: 'Das Ändern dieser Einstellung blockiert den Zugriff für Administratoren, einschließlich dich selbst. Bist du sicher, dass du fortfahren möchtest?',
  com_ui_bulk_delete_error: 'Fehler beim Löschen geteilter Links',
  com_ui_bulk_delete_partial_error: 'Fehler beim Löschen von {0} geteilten Links',
  com_ui_thoughts: 'Gedanken',
  com_ui_thinking: 'Denkt...',
  ...
  com_ui_shared_link_delete_success: 'Geteilten Link erfolgreich gelöscht',
  com_ui_shared_link_bulk_delete_success: 'Geteilte Links erfolgreich gelöscht',
  com_ui_search: 'Suchen',
  ...
  com_nav_show_thinking: 'Denken-Dropdowns standardmäßig öffnen',
  com_nav_info_show_thinking: 'Wenn aktiviert, werden die "Gedanken"-Dropdowns im Chat standardmäßig geöffnet angezeigt, sodass du den Denkprozess der KI live mitverfolgen kannst. Bei Deaktivierung bleiben die "Gedanken"-Dropdowns geschlossen, um eine übersichtlichere Benutzeroberfläche zu gewährleisten.',
};
