...
export default {
  ...
  com_ui_monthly_plan: 'Plano Mensal',
  com_ui_quarterly_plan: 'Plano Trimestral',
  com_ui_yearly_plan: 'Plano Anual',
  com_ui_monthly_benefits: 'Cota de Chat Ilimitada',
  com_ui_quartely_benefits: '10% Economias Mensais',
  com_ui_yearly_benefits: '20% Economias Mensais',
  ...
  com_ui_access_info: 'Aproveite o seu acesso ao AITok, disponível de {subscriptionStartDate} até {expirationDate}.',
  com_ui_renewal_reminder: 'Para um prazer ininterrupto, por favor renove sua assinatura até {expirationDate}.',
