...
export default {
  ...
  com_ui_access_info: 'Profitez de votre accès AITok, disponible du {startTime} jusqu au {endTime}.',
  com_ui_renewal_reminder: 'Pour un plaisir ininterrompu, veuillez renouveler votre abonnement avant le {endTime}.',
