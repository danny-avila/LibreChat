...
export default {
  ...
  com_endpoint_plug_set_custom_instructions_for_gpt_placeholder:
    'Sistem Mesajına dahil edilecek özel talimatlar ayarlayın. Varsayılan: yok',
  com_endpoint_import: 'Karşıya Yükle',
  ...
  com_ui_librechat_code_api_title: 'AI Kodu Çalıştır',
  com_ui_librechat_code_api_subtitle: 'Güvenli. Çok dilli. Giriş/Çıkış Dosyaları.',
  com_ui_librechat_code_api_key: 'LibreChat Kod Yorumlayıcı API anahtarınızı alın',
  com_ui_collapse_chat: 'Sohbeti Daralt',
  com_ui_enter_api_key: 'API Anahtarını Girin',
  com_nav_convo_menu_options: 'Konuşma Menü Seçenekleri',
  com_ui_artifacts: 'Yapay Ürünler',
  com_ui_artifacts_toggle: 'Yapay Ürünler Arayüzünü Aç/Kapat',
  com_nav_info_code_artifacts:
    'Sohbetin yanında deneysel kod yapay ürünlerinin görüntülenmesini sağlar',
  com_ui_include_shadcnui: 'shadcn/ui bileşenleri kullanma talimatlarını dahil et',
  com_nav_info_include_shadcnui:
    'Bu özellik, shadcn/ui bileşenlerinin kullanımını gösteren talimatları içerir. shadcn/ui, Radix UI ve Tailwind CSS kullanılarak oluşturulan yeniden kullanılabilir bileşenler koleksiyonudur. Bu bileşenler hakkında daha fazla bilgi için: https://ui.shadcn.com/',
  com_ui_custom_prompt_mode: 'Özel Talimat Modu',
  com_nav_info_custom_prompt_mode:
    'Bu özellik, varsayılan yapay ürünler sistemi talimatlarının dahil edilmemesi anlamına gelir. Bu modda, tüm yapay ürünler talimatları elle sağlanmalıdır.',
  com_ui_artifact_click: 'Açmak için tıklayın',
  com_a11y_start: 'AI yanıtlamaya başladı.',
  com_a11y_ai_composing: 'AI hala yanıt oluşturuyor.',
  com_a11y_end: 'AI yanıtını tamamladı.',
  ...
  com_error_files_unsupported_capability:
    'Bu dosya türünü destekleyen hiçbir özellik etkinleştirilmemiş.',
  com_error_files_upload: 'Dosya yüklenirken bir hata oluştu.',
  com_error_files_upload_canceled:
    'Dosya yükleme isteği iptal edildi. Not: dosya yüklemesi hala işleniyor olabilir ve manuel olarak silinmesi gerekebilir.',
  com_generated_files: 'Oluşturulan dosyalar:',
  com_download_expired: 'indirme süresi doldu',
  com_download_expires: 'indirmek için buraya tıklayın - {0} tarihinde sona eriyor',
  com_click_to_download: 'indirmek için buraya tıklayın',
  com_sidepanel_conversation_tags: 'Yer İmleri',
  com_assistants_code_interpreter_info:
    'Kod Yorumlayıcı, asistanın kod yazmasını ve çalıştırmasını sağlar. Bu araç, çeşitli veri ve biçimlendirmeye sahip dosyaları işleyebilir ve grafikler gibi dosyalar oluşturabilir.',
  ...
  com_sidepanel_agent_builder: 'Temsilci Oluşturucu',
  com_agents_name_placeholder: 'İsteğe bağlı: Temsilcinin adı',
  com_agents_description_placeholder: 'İsteğe bağlı: Temsilcinizi burada açıklayın',
  com_agents_instructions_placeholder: 'Temsilcinin kullandığı sistem talimatları',
  com_agents_search_name: 'Temsilcileri ada göre ara',
  com_sidepanel_select_agent: 'Bir Temsilci Seç',
  com_agents_update_error: 'Temsilciniz güncellenirken bir hata oluştu.',
  com_agents_create_error: 'Temsilciniz oluşturulurken bir hata oluştu.',
  com_agents_missing_provider_model: 'Lütfen bir temsilci oluşturmadan önce bir sağlayıcı ve model seçin.',
  com_agents_allow_editing: 'Diğer kullanıcıların temsilcinizi düzenlemesine izin verin',
  com_agents_not_available: 'Temsilci Kullanılamıyor',
  com_agents_no_access: 'Bu temsilciyi düzenleme erişiminiz yok.',
  com_agents_enable_file_search: 'Dosya Aramayı Etkinleştir',
  com_agents_file_search_info:
    'Etkinleştirildiğinde, temsilci aşağıda listelenen dosya adlarından tam olarak haberdar edilecek, bu dosyalardan ilgili bağlamı alabilecektir.',
  ...
  com_agents_code_interpreter:
    'Etkinleştirildiğinde, temsilcinizin LibreChat Kod Yorumlayıcı API\'sini kullanarak oluşturulan kodu, dosya işleme dahil olmak üzere güvenli bir şekilde çalıştırmasına olanak tanır. Geçerli bir API anahtarı gerektirir.',
  com_agents_file_search_disabled:
    'Dosya Arama için dosya yüklemeden önce Temsilci oluşturulmalıdır.',
  com_ui_agent_already_shared_to_all: 'Bu temsilci zaten tüm kullanıcılarla paylaşılmış',
  com_ui_agent_editing_allowed: 'Diğer kullanıcılar bu temsilciyi zaten düzenleyebilir',
  com_ui_no_changes: 'Güncellenecek değişiklik yok',
  com_ui_download_artifact: 'Yapay Ürünü İndir',
  ...
  com_nav_welcome_agent: 'Lütfen Bir Temsilci Seçin',
  com_nav_scroll_button: 'Sona kaydır düğmesi',
  com_nav_info_enter_to_send: 'Etkinleştirildiğinde, `ENTER` tuşuna basmak mesajınızı gönderecektir. Devre dışı bırakıldığında, Enter tuşuna basmak yeni bir satır ekler ve mesajınızı göndermek için `CTRL + ENTER` / `⌘ + ENTER` tuşlarına basmanız gerekir.',
  com_nav_info_save_draft: 'Etkinleştirildiğinde, sohbet formuna girdiğiniz metin ve ekler otomatik olarak yerel olarak taslak olarak kaydedilecektir. Bu taslaklar, sayfayı yenileseniz veya başka bir konuşmaya geçseniz bile kullanılabilir olacaktır. Taslaklar cihazınızda yerel olarak depolanır ve mesaj gönderildikten sonra silinir.',
  com_nav_info_show_thinking: 'Etkinleştirildiğinde, sohbet düşünme açılır menülerini varsayılan olarak açık gösterecek, AI\'nin düşünme sürecini gerçek zamanlı olarak görmenize olanak tanıyacaktır. Devre dışı bırakıldığında, düşünme açılır menüleri daha temiz ve düzenli bir arayüz için varsayılan olarak kapalı kalacaktır',
  com_nav_info_fork_change_default: '`Sadece görünen mesajlar` seçilen mesaja giden doğrudan yolu içerir. `İlgili dalları dahil et` yol boyunca dalları ekler. `Buradan tümünü dahil et` tüm bağlantılı mesajları ve dalları içerir.',
  com_nav_info_fork_split_target_setting: 'Etkinleştirildiğinde, çatallama seçilen davranışa göre hedef mesajdan konuşmanın son mesajına kadar başlayacaktır.',
  ...
  com_nav_info_delete_cache_storage: 'Bu eylem, cihazınızda depolanan tüm önbelleğe alınmış TTS (Metinden Konuşmaya) ses dosyalarını silecektir. Önbelleğe alınmış ses dosyaları, daha önce oluşturulmuş TTS sesinin oynatılmasını hızlandırmak için kullanılır, ancak cihazınızda depolama alanı tüketebilir.',
  com_nav_chat_commands: 'Sohbet Komutları',
  com_nav_chat_commands_info: 'Bu komutlar, mesajınızın başında belirli karakterleri yazarak etkinleştirilir. Her komut, belirlenen öneki ile tetiklenir. Mesajlarınızı sık sık bu karakterlerle başlatıyorsanız bunları devre dışı bırakabilirsiniz.',
  ...
  com_nav_slash_command_description: 'Klavye ile bir istem seçmek için \'/\' komutunu aç/kapat',
  com_nav_command_settings: 'Komut Ayarları',
  com_nav_command_settings_description: 'Sohbette hangi komutların kullanılabilir olacağını özelleştirin',
  com_nav_no_search_results: 'Arama sonucu bulunamadı',
  com_ui_speech_while_submitting: 'Yanıt oluşturulurken konuşma gönderilemez',
  ...
  com_nav_maximize_chat_space: 'Sohbet alanını maksimum yap',
};
