...
export default {
  ...
  com_endpoint_frequency_penalty: '频度惩罚度',
  ...
  com_endpoint_not_available: '无可用端点',
  ...
  com_endpoint_config_key_import_json_key_success: '成功导入Service Account JSON Key',
  com_endpoint_config_key_import_json_key_invalid:
    '无效的Service Account JSON Key，您是否导入正确的文件？',
  com_endpoint_config_key_get_edge_key: '为获得Bing访问权限（Access token），请登录：',
  ...
  com_endpoint_config_key_chatgpt: '为获得ChatGPT \'免费版本\'的访问权限（Access token）, 请登录：',
  com_endpoint_config_key_chatgpt_then_visit: '然后访问',
  com_endpoint_config_key_chatgpt_copy_token: '复制access token.',
  com_endpoint_config_key_google_need_to: '您需要开启:',
