...
export default {
  ...
  com_ui_limitation_limited_2021: '对2021年之后的世界和事件了解有限',
  com_ui_experimental: '实验性功能',
  com_ui_ascending: '升序',
  com_ui_descending: '降序',
  com_ui_show_all: '显示全部',
  com_ui_name: '名称',
  com_ui_date: '日期',
  com_ui_storage: '存储',
  com_ui_context: '上下文',
  ...
  com_files_no_results: '没有结果。',
  com_files_filter: '过滤文件...',
  ...
  com_assistants_knowledge_info: '如果你上传文件到知识中，与你的助手的对话可能会包含文件内容。',
  com_assistants_knowledge_disabled:
    '在上传文件作为知识之前，必须创建助手，且代码解释器或检索必须被启用并保存。',
  com_assistants_image_vision: '图像视觉',
  ...
  com_assistants_completed_action: '与 {0} 对话完成',
  com_assistants_completed_function: '运行 {0} 完成',
  com_assistants_function_use: '助手使用了 {0}',
  com_assistants_domain_info: '助手向 {0} 发送了这些信息',
  com_assistants_delete_actions_success: '从助手成功删除操作',
  com_assistants_update_actions_success: '成功创建或更新操作',
  com_assistants_update_actions_error: '创建或更新操作时出现错误。',
  com_assistants_delete_actions_error: '删除操作时出现错误。',
  com_assistants_actions_info: '让你的助手通过 API 检索信息或执行操作',
  com_assistants_name_placeholder: '可选：助手的名称',
  com_assistants_instructions_placeholder: '助手使用的系统指令',
  com_assistants_description_placeholder: '可选：在此描述你的助手',
  com_assistants_actions_disabled: '在添加操作之前，你需要创建一个助手。',
  com_assistants_update_success: '成功更新',
  com_assistants_update_error: '更新你的助手时出错。',
  com_assistants_create_success: '成功创建',
  com_assistants_create_error: '创建你的助手时出错。',
  com_ui_attach_error_type: '端点不支持的文件类型：',
  com_ui_attach_error_size: '端点的文件大小限制超出：',
  com_ui_attach_error: '无法附加文件。创建或选择一个对话，或尝试刷新页面。',
  ...
  com_nav_tool_dialog_description: '助手必须被保存以保持工具选择。',
  com_show_agent_settings: '显示代理设置',
  com_show_completion_settings: '显示完成设置',
  com_hide_examples: '隐藏例子',
  com_show_examples: '显示例子',
