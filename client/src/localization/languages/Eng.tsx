...
export default {
  ...
  com_ui_monthly_price: '140 CNY/month',
  ...
  com_ui_thanks_for_subscribing: 'Heartfelt thanks for subscribing! We&apos;ve successfully processed your payment.',
  com_ui_access_info: 'Delight in your AITok access, available from {startTime} until {endTime}.',
  com_ui_renewal_reminder: 'For uninterrupted enjoyment, kindly renew your subscription by {endTime}.',
