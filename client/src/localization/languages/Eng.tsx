...
export default {
  ...
  com_ui_new_footer: 'All AI conversations and image generations in one place. ',
  com_ui_enter: 'Enter',
  ...
  com_nav_search_placeholder: 'Search rooms',
  ...
  com_premium_warning: 'You must subscribe to get access to all features.',
  com_subscribe_welcome: 'Subscribed! You now have access to all premium features.',

  com_nav_setting_credits: 'Credits',
