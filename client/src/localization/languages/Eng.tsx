...
export default {
  ...
  com_ui_monthly_plan: 'Monthly Plan',
  com_ui_quarterly_plan: 'Quarterly Plan',
  com_ui_yearly_plan: 'Yearly Plan',
  com_ui_monthly_benefits: 'Unlimited Chat Quota',
  com_ui_quartely_benefits: '10% Monthly Savings',
  com_ui_yearly_benefits: '20% Monthly Savings',
  ...
  com_ui_access_info: 'Delight in your AITok access, available from {subscriptionStartDate} until {expirationDate}.',
  com_ui_renewal_reminder: 'For uninterrupted enjoyment, kindly renew your subscription by {expirationDate}.',
  com_ui_payment_failed_title: 'Payment Failed',
  com_ui_encountered_issue: 'We encountered an issue processing your payment: {error}',
  com_ui_try_again_or_contact_support: 'Please try again or contact support for assistance.',
