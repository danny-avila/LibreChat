...
export default {
  ...
  com_nav_management: 'Management',
  com_nav_management_account: 'Account',
  com_nav_management_balance: 'Balance',
  com_nav_management_sensitive_words: 'Sensitive Words',
  com_nav_management_statistics: 'statistics',
