...
export const getLengthAndLastTenChars = (str) => {
...
export const getTextKey = (message, convoId) => {
    ...
    return `${message.messageId ?? ''}${Constants.COMMON_DIVIDER}${getLengthAndLastTenChars(text)}${Constants.COMMON_DIVIDER}${message.conversationId ?? convoId}`;
};
