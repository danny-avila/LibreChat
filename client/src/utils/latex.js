...
export const processLaTeX = (_content) => {
    ...
    processedContent = processedContent
        .replace(inlineLatex, (match, equation) => `$${equation}$`) // Convert inline LaTeX
        .replace(blockLatex, (match, equation) => `$$${equation}$$`); // Convert block LaTeX
    // Restore code blocks
    return restoreCodeBlocks(processedContent, codeBlocks);
};
/**
