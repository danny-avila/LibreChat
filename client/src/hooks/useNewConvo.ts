  ...
  const switchToConversation = useRecoilCallback(
    () =>
      async (
        ...
        // Always update search params, whether or not endpoint/model are defined
        // This ensures params are set for both system defaults and user presets
    ...
    [endpointsConfig, defaultPreset, assistantsListMap, modelsQuery.data, updateSearchParams],
  );
