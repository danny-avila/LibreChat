import { D as keyName, E as base, F as shift, G as process$1 } from "./vendor.BvsoAGbO.js";
class Text {
  /**
...
const colon = 58, parenL = 40, underscore = 95, bracketL = 91, dash$1 = 45, period = 46, hash = 35, percent = 37, ampersand = 38, backslash = 92, newline$1 = 10;
function isAlpha(ch) {
...
const identifiers = new ExternalTokenizer((input, stack) => {
  for (let inside2 = false, dashes = 0, i = 0; ; i++) {
    ...
    if (isAlpha(next) || next == dash$1 || next == underscore || inside2 && isDigit(next)) {
      if (!inside2 && (next != dash$1 || i > 0)) inside2 = true;
...
const descendant = new ExternalTokenizer((input) => {
  if (space$1.includes(input.peek(-1))) {
    let { next } = input;
    if (isAlpha(next) || next == underscore || next == hash || next == period || next == bracketL || next == colon && isAlpha(input.peek(1)) || next == dash$1 || next == ampersand)
...
const lessThan = 60, greaterThan = 62, slash$1 = 47, question$1 = 63, bang = 33, dash = 45;
...
export {
  ...
  EditorState as g,
  historyKeymap as h,
  bracketMatching as i,
  highlightActiveLine as j,
  keymap as k,
  lineNumbers as l,
  EditorSelection as m,
  css as n,
  html as o,
  javascript as p,
  highlightTree as q,
