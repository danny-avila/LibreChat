import { r as reactExports, G as process$1, N as global, j as jsxRuntimeExports, ac as createDragDropManager, ad as equal, ae as j, af as k, R as React } from "./vendor.BvsoAGbO.js";
...
function c(e, t) {
  return (c = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(e2, t2) {
...
var f = reactExports.createContext({}), u = reactExports.createContext("portal"), h = function(t) {
  ...
  n = t, (r = i).prototype = Object.create(n.prototype), r.prototype.constructor = r, c(r, n);
  var l = i.prototype;
  return l.getSnapshotBeforeUpdate = function(e) {
    return e.flipKey !== this.props.flipKey && this.el ? j({ element: this.el, flipCallbacks: this.flipCallbacks, inProgressAnimations: this.inProgressAnimations, portalKey: this.props.portalKey }) : null;
  }, l.componentDidUpdate = function(e, t2, r2) {
    this.props.flipKey !== e.flipKey && this.el && k({ flippedElementPositionsBeforeUpdate: r2.flippedElementPositions, cachedOrderedFlipIds: r2.cachedOrderedFlipIds, containerEl: this.el, inProgressAnimations: this.inProgressAnimations, flipCallbacks: this.flipCallbacks, applyTransformOrigin: this.props.applyTransformOrigin, spring: this.props.spring, debug: this.props.debug, portalKey: this.props.portalKey, staggerConfig: this.props.staggerConfig, handleEnterUpdateDelete: this.props.handleEnterUpdateDelete, decisionData: { previous: e.decisionData, current: this.props.decisionData }, onComplete: this.props.onComplete, onStart: this.props.onStart });
  }, l.render = function() {
    var t2 = this, r2 = this.props, n2 = r2.portalKey, i2 = React.createElement(f.Provider, { value: this.flipCallbacks }, React.createElement(r2.element, { className: r2.className, ref: function(e) {
      return t2.el = e;
    } }, this.props.children));
    return n2 && (i2 = React.createElement(u.Provider, { value: n2 }, i2)), i2;
  }, i;
