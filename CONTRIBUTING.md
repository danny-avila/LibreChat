...
1. Fork the repository and create a new branch with a descriptive kebab-case name (e.g., `new-feature-x`).
...
- Branch names: descriptive and kebab-case (e.g., `new-feature-x`).
