...
const { getTransactionSupport, logger } = require('@brainiac/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('brainiac-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'brainiac-data-provider'
 */
/**
