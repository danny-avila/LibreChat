...
const uploadOpenAIVisionOCR = async ({ req, file, file_id, entity_id }) => {
  ...
  try {
    ...
    const textPreview = extractedText ? extractedText.substring(0, 150) + (extractedText.length > 150 ? '...' : '') : 'No text extracted';
