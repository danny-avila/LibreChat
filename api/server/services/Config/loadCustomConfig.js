...
const { loadYaml } = require('@brainiac/api');
...
const defaultConfigPath = path.resolve(projectRoot, 'brainiac.yaml');
...
https://www.brainiac.ai/docs/configuration/stt_tts`);
    }
