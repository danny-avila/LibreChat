...
https://www.librechat.ai/docs/configuration/stt_tts`);
  ...
  if (customConfig.interface?.marketplace?.use) {
    ...
    if (marketplaceConfig.categories) {
      ...
      const disableDefaultCategories =
        marketplaceConfig.categories.disableDefaultCategories || false;
      ...
      await syncCategories(customCategoriesList, disableDefaultCategories);
    }
  }
