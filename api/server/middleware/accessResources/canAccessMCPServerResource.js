 ...
 * @param {string} [options.resourceIdParam='mcp_id'] - The name of the route parameter containing the MCP server custom ID
...
const canAccessMCPServerResource = (options) => {
  const { requiredPermission, resourceIdParam = 'mcp_id' } = options;
