...
const { unescapeLaTeX, countTokens } = require('@brainiac/api');
const {
  saveConvo,
  getMessage,
  saveMessage,
...
router.post('/branch', async (req, res) => {
  try {
    ...
    /** @type {Array<import('brainiac-data-provider').TMessageContentParts>} */
    ...
    /** @type {import('brainiac-data-provider').TMessage} */
    const newMessage = {
