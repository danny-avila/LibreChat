...
const { isEnabled, getBalanceConfig } = require('@brainiac/api');
const { Constants, CacheKeys, defaultSocialLogins } = require('brainiac-data-provider');
...
router.get('/', async function (req, res) {
  ...
  try {
    ...
    /** @type {TStartupConfig} */
    const payload = {
      appTitle: process.env.APP_TITLE || 'Brainiac',
      ...
      helpAndFaqURL: process.env.HELP_AND_FAQ_URL || 'https://brainiac.ai',
