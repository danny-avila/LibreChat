...
describe('Import Timestamp Ordering', () => {
  ...
  describe('Brainiac Import - Timestamp Issues', () => {
    test('should maintain proper timestamp order between parent and child messages', async () => {
      // Create a Brainiac export with out-of-order timestamps
      const jsonData = {
    ...
    test('recursive format should NOW have timestamp protection', async () => {
      // Create a recursive Brainiac export with out-of-order timestamps
      const jsonData = {
