 ...
 * @returns {Promise<import('brainiac-data-provider').Agent|null>}
 */
let getAgent;
 ...
 * @param {import('brainiac-data-provider').TConversation} params.conversation - The added conversation
 * @param {import('brainiac-data-provider').Agent} [params.primaryAgent] - The primary agent (used to duplicate tools when both are ephemeral)
 * @returns {Promise<import('brainiac-data-provider').Agent|null>} The agent config as a plain object, or null if invalid.
 */
