...
class SelfReflectionTool extends Tool {
  constructor({ message, isGpt3 }) {
    ...
    this.description = `
      ...
      For your input, provide answers for self-evaluation as part of one input,
      using this space as a canvas to explore and organize your ideas in response to the user's message.
      You can use multiple lines for your input.
      Perform this action sparingly and only when you are stuck.
    `;
