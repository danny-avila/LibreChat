...
If you would like to discuss the changes you wish to make, join our [Discord community](https://discord.brainiac.ai), where you can engage with other contributors and seek guidance from the community.
...
8. Setup and run integration tests:
    ...
    - Copy `brainiac.yaml`: `cp brainiac.example.yaml brainiac.yaml`.
    - Run: `npm run e2e`.
