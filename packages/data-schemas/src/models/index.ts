...
import { createMemoryDocumentModel } from './memoryDocument';
import { createSynthesisRunModel } from './synthesisRun';
...
export function createModels(mongoose: typeof import('mongoose')) {
  return {
    ...
    MemoryDocument: createMemoryDocumentModel(mongoose),
    SynthesisRun: createSynthesisRunModel(mongoose),
