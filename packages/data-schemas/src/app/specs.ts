...
import { EModelEndpoint, normalizeEndpointName } from 'bizu-data-provider';
import type { TCustomConfig } from 'bizu-data-provider';

/**
 * Sets up Model Specs from the config (`bizu.yaml`) file.
...
For more information, see the documentation at https://www.bizu.ai/docs/configuration/bizu_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
