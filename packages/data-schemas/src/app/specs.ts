...
import { EModelEndpoint, normalizeEndpointName } from 'vestai-data-provider';
import type { TCustomConfig } from 'vestai-data-provider';

/**
 * Sets up Model Specs from the config (`vestai.yaml`) file.
...
For more information, see the documentation at /docs/configuration/vestai_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
