import { EModelEndpoint, agentsEndpointSchema } from 'brainiac-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'brainiac-data-provider';

/**
 * Sets up the Agents configuration from the config (`brainiac.yaml`) file.
