# Dynamic Theme System for @bizu/client
...
```bash
npm install @bizu/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@bizu/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@bizu/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@bizu/client';
...
```tsx
import { useTheme } from '@bizu/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@bizu/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@bizu/client';
...
This theme system is part of the @bizu/client package. 