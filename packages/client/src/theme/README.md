# Dynamic Theme System for @brainiac/client
...
```bash
npm install @brainiac/client
```

### 2. Wrap Your App with ThemeProvider

```tsx
import { ThemeProvider } from '@brainiac/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@brainiac/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@brainiac/client';
...
```tsx
import { useTheme } from '@brainiac/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@brainiac/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@brainiac/client';
...
This theme system is part of the @brainiac/client package. 