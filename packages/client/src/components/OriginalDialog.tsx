...
>(({ className, style, ...props }, ref) => {
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-surface-overlay/80 fixed inset-0',
        className,
      )}
      {...props}
    />
