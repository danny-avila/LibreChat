    ...
    return (
      <div className={cn('relative', containerClassName)}>
        <input
          ...
          aria-label={label}
          className={cn(
            'peer border-border-light ring-offset-surface-primary placeholder:text-text-secondary flex h-9 w-full rounded-lg border bg-transparent px-3 py-2 text-sm focus-visible:outline-hidden disabled:cursor-not-allowed disabled:opacity-50',
            className,
          )}
          {...props}
        />
