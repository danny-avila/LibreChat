...
export interface SearchConfig {
  ...
  crwApiKey?: string;
  crwApiUrl?: string;
  crwSearchOptions?: CrwConfig['crwSearchOptions'];
}
...
/** fastCRW: open-source, Firecrawl-compatible search and scrape engine; self-host or cloud. */
export interface CrwConfig {
  crwApiKey?: string;
  crwApiUrl?: string;
  crwSearchOptions?: z.infer<typeof webSearchSchema>['crwSearchOptions'];
  crwScraperOptions?: z.infer<typeof webSearchSchema>['crwScraperOptions'];
}
