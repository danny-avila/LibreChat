...
const anthropic: Record<string, SettingDefinition> = {
  ...
  cacheDuration: {
    key: 'cacheDuration',
    label: 'com_endpoint_cache_duration',
    labelCode: true,
    description: 'com_endpoint_anthropic_cache_duration',
    descriptionCode: true,
    type: 'enum',
    default: anthropicSettings.cacheDuration.default,
    options: anthropicSettings.cacheDuration.options,
    component: 'dropdown',
    optionType: 'conversation',
    showDefault: false,
    columnSpan: 2,
