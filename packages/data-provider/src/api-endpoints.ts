...
export const skillFromFile = () => `${skills()}/from-file`;
export const skillFromContent = () => `${skills()}/from-content`;
export const skillFilePreview = (fileId: string) =>
  `${skills()}/file-preview?fileId=${encodeURIComponent(fileId)}`;
