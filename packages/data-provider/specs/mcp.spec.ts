...
describe('MCP_USER_INPUT_FIELDS', () => {
  it('includes the expected user-input fields and excludes server-managed ones', () => {
    ...
    expect(MCP_USER_INPUT_FIELDS.has('chatMenu')).toBe(true);
    expect(MCP_USER_INPUT_FIELDS.has('customUserVars')).toBe(true);
    expect(MCP_USER_INPUT_FIELDS.has('serverInstructions')).toBe(true);
