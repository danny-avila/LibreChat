...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'brainiac-westus'
    expect(groupMap).toHaveProperty('brainiac-westus');
    expect(groupMap['brainiac-westus']).toEqual(
    ...
    // Check groupMap for 'brainiac-eastus'
    expect(groupMap).toHaveProperty('brainiac-eastus');
    expect(groupMap['brainiac-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'brainiac-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'brainiac-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'brainiac-eastus',
