...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'bizu-westus'
    expect(groupMap).toHaveProperty('bizu-westus');
    expect(groupMap['bizu-westus']).toEqual(
    ...
    // Check groupMap for 'bizu-eastus'
    expect(groupMap).toHaveProperty('bizu-eastus');
    expect(groupMap['bizu-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'bizu-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'bizu-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'bizu-eastus',
