...
describe('formatToolContent', () => {
  ...
  describe('resource handling', () => {
    it('should handle UI resources in artifacts', () => {
      ...
      expect(textContent.text).toContain('Resource: carousel');
      expect(textContent.text).toContain('Resource Description: A carousel component');
    ...
    it('should handle mixed UI and regular resources', () => {
      ...
      expect(textEntry.text).toContain('Resource: Data file');
  ...
  describe('complex scenarios', () => {
    it('should handle mixed content with all types', () => {
      ...
      if (Array.isArray(content)) {
        ...
        expect(content[1].text).toContain('Resource: API Data');
        expect(content[1].text).toContain('Resource Description: External data source');
