...
type CreateMethodsType = typeof import('@brainiac/data-schemas').createMethods;
type CreateModelsType = typeof import('@brainiac/data-schemas').createModels;
type RoleBitsType = typeof import('@brainiac/data-schemas').RoleBits;
...
beforeAll(async () => {
  ...
  const dataSchemas = await import('@brainiac/data-schemas');
