...
/**
 * Gate every arm builder calls before emitting SQL. A predicate that lost its
 * tenant or user clause — by a bad refactor, not by forgery — fails here rather
 * than at a customer.
 */
 ...
 * the transaction and nothing leaks onto a pooled connection after release.
 */
