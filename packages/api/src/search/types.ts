 ...
 *
 * `filters-unapplied` is "this backend could not push the listing filters down",
 * which is likewise a standing property rather than an incident: the caller's
 * post-hydration filter is still correct, but its input was ranked without them.
 */
