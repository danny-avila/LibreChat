...
describe('S3 Integration Tests', () => {
  ...
  describe('JS Import Compatibility', () => {
    it('can import crud functions as CommonJS', async () => {
      const crud = await import('../crud');
      expect(typeof crud.getS3Key).toBe('function');
      expect(typeof crud.getS3URL).toBe('function');
      expect(typeof crud.saveBufferToS3).toBe('function');
      expect(typeof crud.uploadFileToS3).toBe('function');
      expect(typeof crud.getS3FileStream).toBe('function');
