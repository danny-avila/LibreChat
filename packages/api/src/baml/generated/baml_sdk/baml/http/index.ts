...
export class SseStream$stream {
  url!: string | null;
  _handle!: _BamlHandle;
  constructor(init: { url: string | null; _handle: _BamlHandle }) {
    Object.assign(this, init);
  }
}
...
export class Response {
   ...
   */
  static new = defineFunction('baml.http.Response.new', 'sync', [
    'status_code',
    'headers',
    'body',
  ]) as (status_code: number, headers: { [key: string]: string }, body: Uint8Array) => Response;
  /**
   * Builds a response to return from an `http.Server` handler.
   *
   * `body` is sent verbatim as the response body. `headers` should include a
   * `Content-Type` if the client needs one; `Content-Length` is set for you.
   */
  static new_async = defineFunction('baml.http.Response.new', 'async', [
    'status_code',
    'headers',
    'body',
  ]) as (
   ...
   * ```
   */
  static new_streaming = defineFunction('baml.http.Response.new_streaming', 'sync', [
    'status_code',
    'headers',
  ]) as (status_code: number, headers: { [key: string]: string }) => Response;
  /**
   * Builds a *streaming* response to return from an `http.Server` handler: the
   * status line and `headers` are sent immediately, then the body is written
   * incrementally with successive `write` calls and ended with `end`. The
   ...
   * ```
   */
  static new_streaming_async = defineFunction('baml.http.Response.new_streaming', 'async', [
    'status_code',
    'headers',
  ]) as (status_code: number, headers: { [key: string]: string }) => Promise<Response>;
  /**
   * Returns the response body as a UTF-8 string.
   * @throws Io
   */
  text = defineInstanceFunction('baml.http.Response.text', 'sync', ['self']).bind(
    this,
  ) as () => string;
  /**
   * Returns the response body as a UTF-8 string.
   * @throws Io
   */
  text_async = defineInstanceFunction('baml.http.Response.text', 'async', ['self']).bind(
    this,
  ) as () => Promise<string>;
  /**
   ...
   * @throws Io
   */
  bytes = defineInstanceFunction('baml.http.Response.bytes', 'sync', ['self']).bind(
    this,
  ) as () => Uint8Array;
  /**
   * Returns the response body as raw bytes.
   * @throws Io
   */
  bytes_async = defineInstanceFunction('baml.http.Response.bytes', 'async', ['self']).bind(
    this,
  ) as () => Promise<Uint8Array>;
  /**
   * Returns `true` if `status_code` is in the 200–299 range.
   */
  ok = defineInstanceFunction('baml.http.Response.ok', 'sync', ['self']).bind(
    this,
  ) as () => boolean;
  /**
   * Returns `true` if `status_code` is in the 200–299 range.
   */
  ok_async = defineInstanceFunction('baml.http.Response.ok', 'async', ['self']).bind(
    this,
  ) as () => Promise<boolean>;
  /**
   ...
   * @throws Io
   */
  write = defineInstanceFunction('baml.http.Response.write', 'sync', ['self', 'data']).bind(
    this,
   ...
   * @throws Io
   */
  write_async = defineInstanceFunction('baml.http.Response.write', 'async', ['self', 'data']).bind(
    this,
  ) as (data: Uint8Array) => Promise<null>;
  /**
   ...
   * @throws Io
   */
  end_async = defineInstanceFunction('baml.http.Response.end', 'async', ['self']).bind(
    this,
  ) as () => Promise<null>;
}
...
export class SseStream {
  url!: string;
  _handle!: _BamlHandle;
  constructor(init: { url: string; _handle: _BamlHandle }) {
    Object.assign(this, init);
  }
  /**
   ...
   * @throws Io
   */
  next = defineInstanceFunction('baml.http.SseStream.next', 'sync', ['self']).bind(this) as () =>
    | string
    | null;
  /**
   * Only returns `null` if the stream is done/closed.
   ...
   * @throws Io
   */
  next_async = defineInstanceFunction('baml.http.SseStream.next', 'async', ['self']).bind(
    this,
  ) as () => Promise<string | null>;
  /**
   * Closes the SSE stream and releases the underlying connection.
   */
  close = defineInstanceFunction('baml.http.SseStream.close', 'sync', ['self']).bind(
    this,
  ) as () => null;
  /**
   * Closes the SSE stream and releases the underlying connection.
   */
  close_async = defineInstanceFunction('baml.http.SseStream.close', 'async', ['self']).bind(
    this,
  ) as () => Promise<null>;
}
 ...
 */
export const _timeout_nanos = defineFunction('baml.http._timeout_nanos', 'sync', ['timeout']) as (
 ...
 * treats as unbounded. Modeled on Rust's `Option<Duration>`.
 */
export const _timeout_nanos_async = defineFunction('baml.http._timeout_nanos', 'async', [
  'timeout',
]) as (timeout: baml.time.Duration | null) => Promise<bigint>;
 ...
 * @throws Timeout
 */
export const fetch = defineFunction('baml.http.fetch', 'sync', ['url'], ['timeout']) as (
  url: string,
  $opts?: { timeout?: baml.time.Duration | null | undefined } | undefined,
) => Response;
 ...
 * @throws Timeout
 */
export const fetch_async = defineFunction('baml.http.fetch', 'async', ['url'], ['timeout']) as (
  url: string,
  $opts?: { timeout?: baml.time.Duration | null | undefined } | undefined,
) => Promise<Response>;
 ...
 * @throws Timeout
 */
export const _fetch = defineFunction('baml.http._fetch', 'sync', ['url', 'timeout_nanos']) as (
  url: string,
 ...
 * @throws Timeout
 */
export const _fetch_async = defineFunction('baml.http._fetch', 'async', [
  'url',
  'timeout_nanos',
]) as (url: string, timeout_nanos: bigint) => Promise<Response>;
 ...
 * @throws Timeout
 */
export const send = defineFunction('baml.http.send', 'sync', ['request'], ['timeout']) as (
  request: Request,
  $opts?: { timeout?: baml.time.Duration | null | undefined } | undefined,
) => Response;
 ...
 * @throws Timeout
 */
export const send_async = defineFunction('baml.http.send', 'async', ['request'], ['timeout']) as (
  request: Request,
  $opts?: { timeout?: baml.time.Duration | null | undefined } | undefined,
) => Promise<Response>;
 ...
 * @throws Timeout
 */
export const _send = defineFunction('baml.http._send', 'sync', ['request', 'timeout_nanos']) as (
  request: Request,
  timeout_nanos: bigint,
) => Response;
 ...
 * @throws Timeout
 */
export const _send_async = defineFunction('baml.http._send', 'async', [
  'request',
  'timeout_nanos',
]) as (request: Request, timeout_nanos: bigint) => Promise<Response>;
 ...
 * @throws Timeout
 */
export const fetch_sse = defineFunction('baml.http.fetch_sse', 'sync', ['request']) as (
  request: Request,
) => SseStream;
 ...
 * @throws Timeout
 */
export const fetch_sse_async = defineFunction('baml.http.fetch_sse', 'async', ['request']) as (
  request: Request,
) => Promise<SseStream>;
...
export class Server$stream {
  addr!: string | null;
  _state!: _BamlHandle;
  constructor(init: { addr: string | null; _state: _BamlHandle }) {
    Object.assign(this, init);
  }
}
...
export class Server {
  addr!: string;
  _state!: _BamlHandle;
  constructor(init: { addr: string; _state: _BamlHandle }) {
    Object.assign(this, init);
  }
  /**
   ...
   * @throws Io
   */
  static bind = defineFunction('baml.http.Server.bind', 'sync', ['addr']) as (
    addr: string,
  ) => Server;
  /**
   * Binds a TCP listener on `addr` and returns a `Server` ready to `serve`.
   ...
   * @throws Io
   */
  static bind_async = defineFunction('baml.http.Server.bind', 'async', ['addr']) as (
    addr: string,
  ) => Promise<Server>;
  /**
   ...
   * @throws Io
   */
  serve = defineInstanceFunction(
    'baml.http.Server.serve',
    'sync',
    ['self', 'handler'],
    [
      'tls_config',
    ...
    $opts?:
      | {
          tls_config?: TlsConfig | null | undefined;
          allow_http1?: boolean | undefined;
          allow_http2?: boolean | undefined;
          max_body_size?: number | undefined;
          max_connections?: number | undefined;
          header_read_timeout?: baml.time.Duration | undefined;
        }
      | undefined,
  ) => null;
  /**
   ...
   * @throws Io
   */
  serve_async = defineInstanceFunction(
    'baml.http.Server.serve',
    'async',
    ['self', 'handler'],
    [
   ...
   * @throws Io
   */
  _serve = defineInstanceFunction('baml.http.Server._serve', 'sync', [
    'self',
    'handler',
    'tls_config',
    'allow_http1',
   ...
   * @throws Io
   */
  _serve_async = defineInstanceFunction('baml.http.Server._serve', 'async', [
    'self',
    'handler',
    'tls_config',
    'allow_http1',
...
export class TlsConfig {
   ...
   * @throws Io
   */
  static new = defineFunction(
    'baml.http.TlsConfig.new',
    'sync',
    ['cert_pem', 'key_pem'],
    ['allow_tls1_2', 'handshake_timeout'],
  ) as (
    cert_pem: Uint8Array,
    key_pem: Uint8Array,
    $opts?:
      | { allow_tls1_2?: boolean | undefined; handshake_timeout?: baml.time.Duration | undefined }
      | undefined,
  ) => TlsConfig;
  /**
   * Parses a PEM-encoded certificate chain and private key into a TLS configuration.
   ...
   * @throws Io
   */
  static _new = defineFunction('baml.http.TlsConfig._new', 'sync', [
    'cert_pem',
    'key_pem',
    'allow_tls1_2',
   ...
   * @throws Io
   */
  static _new_async = defineFunction('baml.http.TlsConfig._new', 'async', [
    'cert_pem',
    'key_pem',
    'allow_tls1_2',
    'handshake_timeout_nanos',
