...
export class JsonDecodeError$stream {
  message!: string | null;
  path!: string | null;
  constructor(init: { message: string | null; path: string | null }) {
...
export class JsonSerializationError$stream {
  ...
  path!: string | null;
  reason!: string | null;
  constructor(init: { message: string | null; path: string | null; reason: string | null }) {
    Object.assign(this, init);
  }
}
...
export class JsonDecodeError {
  message!: string;
  path!: string;
  constructor(init: { message: string; path: string }) {
    Object.assign(this, init);
  }
}
...
export class JsonSerializationError {
  ...
  path!: string;
  reason!: string;
  constructor(init: { message: string; path: string; reason: string }) {
    Object.assign(this, init);
  }
}
 ...
 * @throws JsonParseError
 */
export const parse_async = defineFunction('baml.json.parse', 'async', ['s']) as (
  s: string,
) => Promise<json>;
 ...
 */
export const stringify = defineFunction('baml.json.stringify', 'sync', ['j']) as (
  j: json,
) => string;
 ...
 * Serializes a `json` value `j` to a compact JSON string.
 */
export const stringify_async = defineFunction('baml.json.stringify', 'async', ['j']) as (
  j: json,
) => Promise<string>;
 ...
 */
export const stringify_pretty = defineFunction('baml.json.stringify_pretty', 'sync', ['j']) as (
  j: json,
) => string;
 ...
 * Serializes a `json` value `j` to a pretty-printed (indented) JSON string.
 */
export const stringify_pretty_async = defineFunction('baml.json.stringify_pretty', 'async', [
  'j',
]) as (j: json) => Promise<string>;

/**
 * @throws JsonSerializationError
 */
export const to_string = defineFunction('baml.json.to_string', 'sync', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => string;
 ...
 * @throws JsonSerializationError
 */
export const to_string_async = defineFunction('baml.json.to_string', 'async', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => Promise<string>;

/**
 * @throws JsonSerializationError
 */
export const to_json = defineFunction('baml.json.to_json', 'sync', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => json;
 ...
 * @throws JsonSerializationError
 */
export const to_json_async = defineFunction('baml.json.to_json', 'async', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => Promise<json>;
 ...
 * @throws JsonSerializationError
 */
export const from = defineFunction('baml.json.from', 'sync', ['value'], undefined, {
  typeParams: ['T'],
}) as <T>(value: T) => json;
 ...
 * @throws JsonSerializationError
 */
export const from_async = defineFunction('baml.json.from', 'async', ['value'], undefined, {
  typeParams: ['T'],
}) as <T>(value: T) => Promise<json>;

/**
 * @throws JsonParseError
 * @throws JsonDecodeError
 */
export const from_string = defineFunction('baml.json.from_string', 'sync', ['s'], undefined, {
  typeParams: ['T'],
}) as <T>(s: string) => T;
 ...
 * @throws JsonDecodeError
 */
export const from_string_async = defineFunction(
 ...
 * @throws JsonDecodeError
 */
export const from_json = defineFunction('baml.json.from_json', 'sync', ['j'], undefined, {
  typeParams: ['T'],
}) as <T>(j: json) => T;
 ...
 * @throws JsonDecodeError
 */
export const from_json_async = defineFunction('baml.json.from_json', 'async', ['j'], undefined, {
  typeParams: ['T'],
}) as <T>(j: json) => Promise<T>;

/**
 * @throws JsonDecodeError
 */
export const to = defineFunction('baml.json.to', 'sync', ['j'], undefined, {
  typeParams: ['T'],
}) as <T>(j: json) => T;
 ...
 * @throws JsonDecodeError
 */
export const to_async = defineFunction('baml.json.to', 'async', ['j'], undefined, {
  typeParams: ['T'],
}) as <T>(j: json) => Promise<T>;

export const field = defineFunction('baml.json.field', 'sync', ['j', 'key']) as (
  j: json,
  key: string,
) => json;

export const field_async = defineFunction('baml.json.field', 'async', ['j', 'key']) as (
  j: json,
  key: string,
) => Promise<json>;
 ...
 * @throws JsonSerializationError
 */
export const serialize = defineFunction('baml.json.serialize', 'sync', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => string;
 ...
 * @throws JsonSerializationError
 */
export const serialize_async = defineFunction('baml.json.serialize', 'async', ['v'], undefined, {
  typeParams: ['T'],
}) as <T>(v: T) => Promise<string>;
 ...
 * @throws JsonDecodeError
 */
export const deserialize = defineFunction('baml.json.deserialize', 'sync', ['s'], undefined, {
  typeParams: ['T'],
}) as <T>(s: string) => T;
