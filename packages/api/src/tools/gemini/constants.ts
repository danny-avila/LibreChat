/**
 * Display message shown to users after image generation
 * DO NOT MODIFY - kept exactly as original
 */
...
/**
 * Tool description shown in UI and to users
 * DO NOT MODIFY - kept exactly as original
 */
export const TOOL_DESCRIPTION = `Generates high-quality, original images based on text prompts, with optional image context.
...
/**
 * Description for the model/agent
 * DO NOT MODIFY - kept exactly as original
 */
export const DESCRIPTION_FOR_MODEL = `Use this tool to generate images from text descriptions using Google Gemini.
...
/**
 * Prompt field description for schema
 * DO NOT MODIFY - kept exactly as original
 */
...
/**
 * Image IDs field description for schema
 * DO NOT MODIFY - kept exactly as original
 */
export const IMAGE_IDS_DESCRIPTION = `
...
/** Default model ID for Gemini image generation */
export const DEFAULT_MODEL_ID = 'gemini-2.5-flash-image-preview';

/** Tool name identifier */
export const TOOL_NAME = 'gemini_image_gen';
