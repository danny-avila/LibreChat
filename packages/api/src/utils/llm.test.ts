import { extractBizuParams } from './llm';

describe('extractBizuParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractBizuParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractBizuParams();
  ...
  it('should extract all Bizu params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractBizuParams(options);
  ...
  it('should handle null values for Bizu params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Bizu params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractBizuParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Bizu params', () => {
    const options = {
      resendFiles: false,
