  ...
  private createUserPool(props: CognitoStackProps) {
    const userPool = new cognito.UserPool(this, 'AIAssistantUserPool', {
      ...
      userVerification: {
        ...
        emailBody:
          'Hello {username}, Thanks for signing up for NJ AI Assistant! Your verification code is {####}',
        emailStyle: cognito.VerificationEmailStyle.CODE,
        smsMessage:
          'Hello {username}, Thanks for signing up to NJ AI Assistant! Your verification code is {####}',
      },
