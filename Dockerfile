...
ARG VITE_SHOW_OPENID_LOGIN_OPTION
ARG VITE_SHOW_OPENID_LOGIN_NAME
...
ENV VITE_SHOW_OPENID_LOGIN_OPTION=$VITE_SHOW_OPENID_LOGIN_OPTION
ENV VITE_SHOW_OPENID_LOGIN_NAME=$VITE_SHOW_OPENID_LOGIN_NAME
