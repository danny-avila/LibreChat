...
(async () => {
  ...
  console.purple('Removing all tags for Brainiac `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/brainiac-dev-api', 'brainiac-client'];
  ...
  console.purple('Pulling latest Brainiac images...');
