...
(async () => {
  ...
  console.purple('Removing all tags for Bizu `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/bizu-dev-api', 'bizu-client'];
  ...
  console.purple('Pulling latest Bizu images...');
