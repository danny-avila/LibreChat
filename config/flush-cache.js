...
/**
 * Brainiac Cache Flush Utility
 *
 * This script flushes the cache store used by Brainiac, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Brainiac. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Brainiac backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Brainiac Cache Flush Utility');
  console.log('================================');
