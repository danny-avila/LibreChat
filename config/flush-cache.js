...
/**
 * Bizu Cache Flush Utility
 *
 * This script flushes the cache store used by Bizu, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Bizu. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Bizu backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Bizu Cache Flush Utility');
  console.log('================================');
